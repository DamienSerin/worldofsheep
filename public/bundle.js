...
var Game = function () {
    ...
    _createClass(Game, [{
        ...
        key: 'placePlayer',
        value: function placePlayer(playerId) {
            var player = this.addPlayer(playerId);
            var tmp = this.map.spawns[Math.floor(Math.random() * this.map.spawns.length)];
            var canSpawn = false;
            while (!canSpawn) {
                canSpawn = true;
                var _iteratorNormalCompletion = true;
...
var Map = function () {
    ...
    _createClass(Map, [{
        key: 'generateMap',
        value: function generateMap(map) {
            var x = 0;
            var y = 0;
